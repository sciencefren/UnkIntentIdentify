...
if __name__ == '__main__':
    ...
    input_tensor_name_lst = ['input_x:0', 'drop_keep_pro:0']
    conv_name2filtersize_dct = dict([('representation_layer/conv-maxpool-{}/relu:0'.format(filtersize), filtersize) for filtersize in [2, 3, 5]])
    ...
    #获取cam结果
    res_cam = cam.get_text_final_cam(input_value_lst, 'top', max_sentence_len, true_length)
    print(res_cam)
