...
def train(dataset):
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            pwc_ckpt_path = '../../../../UnkIntentIdentifyModel/joint_mt_ckpt_02/'
            ...
            while True:
                ...
                print('x info:{:.4} {:.4}, x unlabeled info:{:.4} {:.4}'.format(batch_x.mean(), batch_x.std(), batch_x_unlabeled.mean(), batch_x_unlabeled.std()))
